...
public class qlkh extends javax.swing.JPanel {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        if (selectedRow == -1) {
            javax.swing.JOptionPane.showMessageDialog(this, "Vui lòng chọn khóa học cần xóa!");
            return;
        }

        // Lấy ID khóa học từ hàng được chọn
        String id = table.getValueAt(selectedRow, 0).toString();

        // Xóa giáo viên khỏi danh sách
        Course.getAllCourses().remove(id);
        ...
        javax.swing.JOptionPane.showMessageDialog(this, "Đã xóa khóa học thành công!");
